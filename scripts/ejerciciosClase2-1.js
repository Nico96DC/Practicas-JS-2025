...
let eleccion, limpiado, respuesta, resultadoLogico, ej6Completado = false
while (true) {
    eleccion = prompt("Sintaxis básica.\nSelecciona una opción:\n1. Variable con nombre\n2. Suma de dos números\n3. Operadores lógicos\n4. let y const\n5. Comentario explicativo\n6. Variable boolean y operación lógica\n7. Tipo de dato con typeof\n8. Declarar un array\n9. Operación con %\n10. Variable sin valor inicial\n\nPresiona otro número para salir.");
    switch (eleccion) {
        case "1":
        ...
        case "5":
            ...
            // Este código realiza varias operaciones básicas de JavaScript como declarar variables, sumar números, usar operadores lógicos, y mostrar resultados en la consola.
